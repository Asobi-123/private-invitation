...
- Entering a new character now clears older stored jealousy departure snapshots, and navigation snapshots are sampled again after short delays to avoid stale last-chat data during consecutive jealousy tests.
